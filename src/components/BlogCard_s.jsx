...
const BlogCard_s = ({
  ...
  return (
    <div className="flex flex-col gap-[30px] py-10 px-[5.55%] border-y border-[#98989A]">
      <div className="flex justify-between items-center">
        <div className="flex gap-2">
          ...
          <div className="flex flex-col">
            <h2 className="text-white font-semibold text-lg 2xl:text-xl">
              {name}
            </h2>
